...
# run_model_and_evaluate(params,monotony)
# 
# params = c("depth"=3,"nobs_in_node"=10,"shrinkage"=.05,"ntrees"=200)
# run_model_and_evaluate(params,monotony)
# 
# params = c("depth"=4,"nobs_in_node"=10,"shrinkage"=.05,"ntrees"=200)
# run_model_and_evaluate(params,monotony)
